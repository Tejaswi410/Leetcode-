...
public class feb_24 {
    public boolean findBobPath(List<List<Integer>> adj, int bob, int parent, List<Integer> currPath,
    ...
    public int findMaxIncomeForAlice(List<List<Integer>> adj, int alice, int parent, int[] amount) {
